  ...
  return (
    <div className="carousel w-full h-[600px] ">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute h-full flex items-center bg-gradient-to-r from-[#1E1E1E] top-0 gap-6  left-0  ">
          <div className="space-y-7  w-1/3 pl-16 ">
            <h1 className="text-6xl font-bold text-white ">Affordable Price For Car Servicing</h1>
            <p className="text-white">There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
          
            <div>
            <button className="btn bg-[#FF3811] mr-6 text-white ">DISCOVER ME</button>
